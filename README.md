...
| OS | Snippet |
|:---:|:---|
| `macOS` | `bash -c "$(curl -LsS https://raw.github.com/yashodhank/dotfiles-3/master/src/os/setup.sh)"` |
| `Ubuntu` | `bash -c "$(wget -qO - https://raw.github.com/yashodhank/dotfiles-3/master/src/os/setup.sh)"` |
